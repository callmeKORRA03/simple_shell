...
## Description
This repository contains the executable files to simulate a simple Unix shell with its respective basic commands as well as some advanced ones developed by the contributor. **Chibuike Favour** <br>
...
## issue faced
** Issue with Betty **
** Most of my files doesn't meet the betty recomendations  like the 40 lines per function**


## Author
### * **Chibuike Favour** [Github](https://github.com/callmeKORRA03)
